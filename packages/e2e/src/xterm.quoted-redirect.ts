export const name = 'viewlet.terminal-xterm-quoted-redirect'
...
export const test = async ({ Command, expect, KeyBoard, Locator, Settings }) => {
  ...
  await runCommand(terminal, KeyBoard, 'echo "hello world" > greeting.txt')
  await runCommand(terminal, KeyBoard, 'cat greeting.txt')
